...
import com.ernando.socialBooks.services.AutoresService;
...
public class AutoresResource {
	...
	public ResponseEntity<Void> salvar(@Valid @RequestBody Autor autor) throws AutorExistenteException{
	...
	public ResponseEntity<Autor> buscar(@PathVariable("id") Long id) throws AutorNaoEncontradoException{
